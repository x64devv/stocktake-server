-- =============================================================================
-- StockTake Full Demo Seed - Fresh Data
-- Run:
--   Get-Content "C:\Users\Wyne\...\seed.sql" | docker exec -i stocktake-db psql -U stocktake -d stocktake
-- =============================================================================
...
-- ── Session ───────────────────────────────────────────────────────────────────
INSERT INTO sessions (id, store_id, session_date, type, status, variance_tolerance_pct, created_by) VALUES
(
...
(gen_random_uuid(), '66666666-6666-6666-6666-000000000001', '44444444-4444-4444-4444-000000000006', 'ITEM-012', '55555555-5555-5555-5555-000000000003', 42, NOW() - INTERVAL '2 hours', 0, gen_random_uuid());

-- Rudo: recount for ITEM-011 (round 1 — after admin flagged it)
INSERT INTO count_lines (id, session_id, bay_id, item_no, counter_id, quantity, counted_at, round_no, client_uuid) VALUES
...
-- ── Variance flags ────────────────────────────────────────────────────────────
-- ITEM-001: counted 45 vs theoretical 48 = -6.25%  → PENDING (demo accept/reject)
-- ITEM-007: counted 80 vs theoretical 96 = -16.67% → PENDING (demo accept/reject)
-- ITEM-011: counted 10 vs theoretical 18 = -44.44% → ACCEPTED (already resolved)
